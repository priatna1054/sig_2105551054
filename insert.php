<?php
    ...
    if(isset($_POST['submite'])){
        ...
        $hasil = mysqli_query($koneksi, "INSERT INTO tb_data_rs VALUES('$id', '$nama_rs', '$alamat', '$website', '$latitude', '$longitude')");
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">Tambah Data</div>
